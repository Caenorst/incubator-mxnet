...
*/
#ifndef MXNET_OPERATOR_CONTRIB_ADD_RELU_SPLIT_INL_H_
#define MXNET_OPERATOR_CONTRIB_ADD_RELU_SPLIT_INL_H_
...
#endif  // MXNET_OPERATOR_CONTRIB_ADD_RELU_SPLIT_INL_H_
